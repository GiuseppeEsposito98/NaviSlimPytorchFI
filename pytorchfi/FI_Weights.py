...
class FI_report_classifier(object):
    ...
    def create_report(self,file_name, log_folder):
        ...
        # print(os.path.exists(os.path.join(log_folder,old_report_name)))
        # sys.exit()
        if os.path.exists(os.path.join(log_folder,old_report_name)):
            os.system(f"cp {os.path.join(log_folder,old_report_name)} {os.path.join(log_folder,new_golden_name)}")
        self._report_dictionary=self.load_report(log_folder, new_golden_name)
